...
<section class = "home_section">
    <div class="section-header">
		...
		<div class="section-tagline">
            From as low as Rs 2000/day with limited time offer discounts
		</div>					
	</div>
</section>
    ...
    <div class = "container-fluid">
        <div class = "row">
            ...
            <div class = "col-md-6 right-area" style = "padding:50px">
                ...
                <p>
                Welcome to our online cab booking system, where convenience meets reliability to redefine your travel experience. With a commitment to seamless service and customer satisfaction, we aim to be your trusted partner on every journey.Safety is our top priority. Each of our drivers undergoes rigorous screening and training to guarantee a secure and comfortable ride for every passenger. 
                Our vehicles are regularly inspected to maintain the highest standards of safety and cleanliness, giving you peace of mind throughout your journey.Whether you're traveling for business or leisure, solo or with a group, our online cab booking system is here to make your journey effortless and enjoyable. Experience the difference with us and let us take you where you need to go, reliably and comfortably, every time.
                </p>
				...
				<form method="POST" action = "reserve.php" class = "car-reservation-form" id = "reservation_form" v-on:submit = "checkForm">
					...
					<div>
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "pickup_location" placeholder = "JJ" v-model = 'pickup_location'>
						...
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "return_location" placeholder = "JJ" v-model = 'return_location'>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        Mo<span style = "color:#04DBC0">Cab</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>GIET University Gunupur
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>mocab@gmail.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+91 99849 82472
                        </li>
                    </ul>
                </div>
            </div>
